(function(angular, $, _) {
  ...
  inkyCompose.controller('InkyComposeController', function($scope, $sce, crmApi){
    ...
    // This if statement is a fairly large hack. We only do any
    if($scope.$parent.mailing.template_type == 'inky'){

      $('div#tab-mailing > div:nth-child(1) > div:nth-child(3)').hide()
      $('div#tab-mailing > div:nth-child(1) > div:nth-child(4)').hide()
